...
program NumInt_exercise_2
    ...
    write(*,'(A,i0)') 'Initial value of quadrature point: ', initNGauss
    write(*,'(A,i0)') 'Total number of Gaussian quadrature points: ', totNGauss
    write(*,*)
    !
    ...
    ! --- Romberg method ---
    !
    call GaussQuadrature(lil,uil,initNGauss,totNGauss,threshold,IRC,totiter,uf)
    !
