...
t, prey, predator, preyRK, predatorRK = np.loadtxt(fichero_datos, unpack=True, skiprows=1)
...
ax.plot( t,predatorRK, lw=1.0,          color='k', label='Foxes, $x$ RK4'   )
ax.plot( t,preyRK    , lw=1.0, ls='--', color='k', label='Rabbits, $y$ RK4' )
ax.plot( t,predator  ,                             label='Foxes, $x$'       )
ax.plot( t,prey      ,         ls='--',            label='Rabbits, $y$'     )
